		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<a href="<?php echo base_url('admin/freelance/graphic');?>" class="float-left text-primary" style="text-decoration:none;"><i class="fas fa-arrow-left "></i> Back</a>
					...
					<div class="dropdown-menu" style="padding:0; border:0; background-color: transparent">
						<div class="dropdown-item ml-1" style="padding:0;">
							...
							<input class="btn btn-success" type="submit" formaction="<?php echo base_url('admin/freelance/retoregp');?>" name="btn" value="Restore data"/>
							<input class="btn btn-danger" type="submit" formaction="<?php echo base_url('admin/freelance/delpermagp');?>" name="btn" value="Delete Permanent"/>
						</div>
					</div>
					</div>
					...
					<hr>
						...
						<div class="table-responsive">
							...
							<thead>
								...
								<tbody>
									<?php $i=1; foreach ($delgraphic as $ts): ?>
									<tr>
									<?php if($ts->approve == "1"){?>
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-footer">
			...
			<a id="btn-trash" class="btn btn-success" href="<?php echo site_url('admin/freelance/restore2/'.$g->id_freelance) ?>">Restore data</a>
