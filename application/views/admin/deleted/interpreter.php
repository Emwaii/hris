		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<a href="<?php echo base_url('admin/freelance/interpreter');?>" class="float-left text-primary" style="text-decoration:none;"><i class="fas fa-arrow-left "></i> Back</a>
					...
					<div class="dropdown-menu" style="padding:0; border:0; background-color: transparent">
						<div class="dropdown-item ml-1" style="padding:0;">
							...
							<input class="btn btn-success" type="submit" formaction="<?php echo base_url('admin/freelance/retorein');?>" name="btn" value="Restore data"/>
							<input class="btn btn-danger" type="submit" formaction="<?php echo base_url('admin/freelance/delpermain');?>" name="btn" value="Delete Permanent"/>
						</div>
					</div>
					</div>
					...
					<hr>
						...
						<div class="table-responsive">
							...
							<thead>
								...
								<tbody>
									<?php $i=1; foreach ($delinterpreter as $ts): ?>
									<tr>
									<?php if($ts->approve == "1"){?>
...
<!-- ########################### Delete ##################################### -->
<?php foreach($delinterpreter as $g):?>
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-footer">
			...
			<a id="btn-trash" class="btn btn-success" href="<?php echo site_url('admin/freelance/restore3/'.$g->id_freelance) ?>">Restore data</a>
