				...
				<div class="card mb-3">
					...
					<div class="dropdown-menu" style="padding:0; border:0; background-color: transparent">
						<div class="dropdown-item ml-1" style="padding:0;">
							...
							<input class="btn btn-warning" type="submit" formaction="<?php echo base_url('admin/freelance/movetrashsub');?>" name="btn" value="Move to Trash"/>

							<input class="btn btn-danger" type="submit" formaction="<?php echo base_url('admin/freelance/permasub');?>" name="btn" value="Delete Permanent"/>
						</div>
					</div>
					</div>
					...
					<hr>
						...
						<div class="table-responsive">
							...
							<thead>
								...
								<tbody>
									<?php $i=1; foreach ($subtitler as $ts): ?>
									<tr>
									<?php if($ts->approve == "1"){?>
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-footer">
			...
			<a id="btn-trash" class="btn btn-warning" href="<?php echo site_url('admin/freelance/trash4/'.$g->id_freelance) ?>" >Move to trash</a>
