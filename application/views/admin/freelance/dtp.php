			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo base_url('admin/freelance/deldtp');?>" class="float-left text-danger" style="text-decoration:none;"><i class="fas fa-trash "></i> Trash</a>
						<a target="_blank" href="<?php echo base_url('admin/freelance/exp_dtp');?>" class="float-right"style="text-decoration:none;"><i class="fas fa-print "></i> Rekap</a>
					...
					<div class="dropdown-menu" style="padding:0; border:0; background-color: transparent">
						<div class="dropdown-item ml-1" style="padding:0;">
							...
							<input class="btn btn-warning" type="submit" formaction="<?php echo base_url('admin/freelance/movetrashdtp');?>" name="btn" value="Move to Trash"/>
							<input class="btn btn-danger" type="submit" formaction="<?php echo base_url('admin/freelance/permadtp');?>" name="btn" value="Delete Permanent"/>
						</div>
					</div>
					</div>
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-footer">
			...
			<a id="btn-trash" class="btn btn-warning" href="<?php echo site_url('admin/freelance/trash1/'.$g->id_freelance) ?>" >Move to trash</a>
			<a id="btn-permanen" class="btn btn-danger" href="<?php echo site_url('admin/freelance/delete1/'.$g->id_freelance) ?>">Delete permanent</a>
    	</div>
	</div>
  </div>
</div>
