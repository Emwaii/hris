...
<body>
	...
	<?php
		$dat = "Graphic_designer_".date('d/m/Y')."_".substr(md5(time()), 0, 4).".xls";
	...
	<center>
		<p>Graphic Designer <?= date('d/m/Y')?></p>
	</center>
	...
	<table border="1">
        ...
        rfreelance.id_lang = language_pair.id_lang where rfreelance.id_job = 4 and COALESCE(rfreelance.deleted,0) = 0");
        ?>
