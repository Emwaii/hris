					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/absen/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input type="radio" name="absen" checked="" class="custom-control-input" value="M"><span class="custom-control-label" >Masuk</span>
								</label>
								
								<label class="custom-control custom-checkbox custom-control-inline">
								<input type="radio" name="absen" class="custom-control-input" value="T"><span class="custom-control-label" >Tidak Masuk</span>
								</label>
								...
								<label class="custom-control custom-checkbox custom-control-inline">
								<input type="radio" name="absen" class="custom-control-input" value="A"><span class="custom-control-label" >Alpha</span>
								</label> -->
							</div>
							</div>
